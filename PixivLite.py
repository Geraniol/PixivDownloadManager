...
if phpsessid == "Null":
    print("请从已登陆浏览器的 Cookie 中复制 PHPSESSID 至程序头部变量处")
    exit()
...
def getFollowingId(home):
    ...
    i = 0
    while True:
        url = f"https://www.pixiv.net/ajax/user/{str(home)}/following?offset={str(100*i)}&limit=100&rest=show"
